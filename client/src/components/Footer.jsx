  ...
  return (
    <footer className="main-footer" data-aos="fade-up" data-aos-offset="0">
      <div className="footer-container">
        ...
        <div className="footer-section brand-column" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
        ...
        <div className="footer-section" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
        ...
        <div className="footer-section" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom" data-aos-delay="300">
